...
*/
contract RopeCoin is ERC20 {
    /*
    This section defines the internal variable of the smart contract. Remember that because
    ...
    */
    ...
    constructor(uint256 _max_mint, uint256 _max_mint_per_user) ERC20("RopeCoin", "RPC") {
    ...
    function mint(uint256 _amount) external {
        ...
        require(minted[account] + amount <= max_mint_per_user, "Cannot mint this much");
